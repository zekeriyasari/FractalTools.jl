...
z = getindex.(func.(region.x, region.y), 1)
t = getindex.(func.(region.x, region.y), 2)

# Refine region to evaluate interpolated function
subdiv = 3
x, y = refine(gmsh2matplotlibtri(meshes[1]), subdiv, true)
...
interpolant, coeffs = hiddenfis(region, z, t, α7=α7, α8=α8, α11=α11, α12=α12, func0=func0, num_iter=10, get_coeffs=true)
